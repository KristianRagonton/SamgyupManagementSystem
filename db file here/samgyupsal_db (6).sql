...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2024 at 09:12 AM
...
(1, 'Pork', 'Goods', 480, 'kilogram/s', 100, 0),
...
(14, '953369', 'Mrs. Garcias Meats', '2024-05-09', '2024-05-10', 40900, 0);
...
(1, 967652, 14, 967652, 1000, 100, 2151.96, 3),
(18, 223000, 16, 2230000, 1112, 222, 0, 0),
(34, 16445, 12, 164450, 3168, 33, 0, 0),
(35, 15565, 10, 155650, 2224, 444, 0, 0),
(36, 16400, 14, 164000, 2780, 555, 0, 0),
(37, 14300, 8, 143000, 6336, 66, 0, 0),
(38, 15450, 14, 154500, 7742, 7, 0, 0),
(39, 14555, 12, 145550, 8448, 88, 0, 0),
...
--
ALTER TABLE `goods_invoice`
  MODIFY `goods_invoice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT for table `goods_stockout_forms`
--
ALTER TABLE `goods_stockout_forms`
  MODIFY `goods_stockout_form_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `goods_stock_in`
--
ALTER TABLE `goods_stock_in`
  MODIFY `goods_stockin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;

--
-- AUTO_INCREMENT for table `goods_stock_out`
--
ALTER TABLE `goods_stock_out`
  MODIFY `goods_stockout_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
...
--
ALTER TABLE `payroll`
  MODIFY `payroll_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;
...
--
ALTER TABLE `payroll_reports`
  MODIFY `payroll_report_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `payroll_report_salaries`
--
ALTER TABLE `payroll_report_salaries`
  MODIFY `report_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=205;
